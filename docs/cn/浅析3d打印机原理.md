...
5. 将打印机主板连接到电脑, 点击`vscode`下方状态栏的➡, 上述代码会被自动编译并上传到打印机主板中
   ...
   ![image-20220325103304531](浅析3d打印机原理.assets/image-20220325103304531.png)
...
![image-20220330052739266](浅析3d打印机原理.assets/image-20220330052739266.png)
...
#### 后记
  ...
  希望这篇文章对你有一点点用, 至少读起来能有一些趣味. 如果是的话, 老板能不能施舍我5块钱?

![image-20220330045514907](浅析3d打印机原理.assets/image-20220330045514907.png)
